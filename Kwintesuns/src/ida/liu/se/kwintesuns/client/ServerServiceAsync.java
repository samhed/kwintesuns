...
public interface ServerServiceAsync {
	...
	void flagPost(Long postId, String flagger, AsyncCallback<Boolean> asyncCallback);
	...
	void flagComment(Long commentId, String flagger, AsyncCallback<Boolean> asyncCallback);
}
